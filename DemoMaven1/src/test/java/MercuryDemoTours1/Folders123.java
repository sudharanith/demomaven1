...
import MercuryDemoTours.ExcelApiTest3;
...
public class Folders123 {
    ...
    public static String sTargetTestCasePath="",FolderPath="",TestName="";
 
 public static void CreateFolder(String TestName)
 {
	 
		try {
	
			List<String> Myarray1 = Folders123.Hello(TestName); // KeyImp
  ...
  //Hello starts
  public static ArrayList<String>   Hello(String TestName )
  {
...
public static  void takeSnapShot(String SheetPath1,String TestClassName,int rownum,int column,String FolderPath)
{
		...
		//driver=OR.driver;
	     ...
	     String fileWithPath=str;
	      ...
	      TakesScreenshot scrShot =((TakesScreenshot)Test5.driver);
