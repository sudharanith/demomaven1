...
public static void MerucryFlightFinderBusiness() throws Exception
{
	...
	Folders123.takeSnapShot(OR.sTargetTestCaseExcelPath,OR.sTestCaseName,3,6,OR.sTargetFolderPath);
	
	CommonUtility.driver.findElement(By.xpath(OR.MFFPage_ContinueButton)).click();
...
public static void MerucryFlightFinderEconomy() throws Exception
{
	...
	CommonUtility.driver.findElement(By.xpath(OR.MFFPage_EconomyclassRadioButton)).click();
...
public static void MerucryFlightFinderFirst() throws Exception
{
	...
	CommonUtility.driver.findElement(By.xpath(OR.MFFPage_FirstClassRadioButton)).click();
