...
/*	 public static void GetInputData(int i) throws Exception
		...
		*/
		 ...
		 public static void mercurylogin(String Username,String Password)throws Exception
		 {
			 ...
			 //Test5.GetInputData();
			 driver.findElement(By.xpath(OR3.MLPage_UserNameTextbox)).sendKeys(Test5.UserName);
			 driver.findElement(By.xpath(OR3.MLPage_PasswordTextbox)).sendKeys(Test5.Password);
