...
public class MercuryLogin
{
	...
	public static String UserName,Password;
	 ...
	 public static void callallmethods()throws Exception
	 {
		 ...
		 {	 
			 	System.out.println("test Iteration count"+i);
			 	 MercuryLogin.GetInputData(i);
				 MercuryLogin.openBrowser();
				 MercuryLogin.mercurylogin();
				 MercuryLogin.CloseBrowser();
	 ...
	 public static void GetInputData(int i) throws Exception
		{
				  ExcelApiTest3 eat = new ExcelApiTest3();
				   MercuryLogin.UserName=eat.getCellData("E://TC16.xls","Sheet1",i,0);
				   MercuryLogin.Password=eat.getCellData("E://TC16.xls","Sheet1",i,1);
		 ...
		 public static void mercurylogin()throws Exception
		 {
			 ...
			 //Test5.GetInputData();
			 driver.findElement(By.xpath(OR3.MLPage_UserNameTextbox)).sendKeys(MercuryLogin.UserName);
			 driver.findElement(By.xpath(OR3.MLPage_PasswordTextbox)).sendKeys(MercuryLogin.Password);
