...
public class mercury {
  ...
  public static void signin()throws Exception
  {
	  ...
	  driver.findElement(By.xpath(OR.username)).sendKeys("mercury");

	  
	  driver.findElement(By.xpath(OR.password)).sendKeys("mercury");
	  
	  driver.findElement(By.xpath(OR.signin)).click();
